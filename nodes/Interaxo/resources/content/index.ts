		...
		options: [
			{
				...
				description: 'Delete a file, folder or entry',
			},
			{
				name: 'Get',
				value: 'get',
				action: 'Get a content item',
				description: 'Get a single content item of any type',
			},
			{
				name: 'List Children',
				value: 'listChildren',
				action: 'List children of a content item',
				description: 'List the direct children of a folder or entry',
			},
			{
...
export async function contentListChildren(
	...
	return interaxoRequestPaged.call(
		this,
